...
<head>
    <title>Programs List | Injot Dahar - A Non Government Organization</title>
...
<body>
    ...
    <div class="boxed_wrapper">
        ...
        <section class="event-section sec-padd3 style-3">
            <div class="container">
                ...
                <div class="row">
                    <div class="item col-md-3 col-sm-6 col-xs-12">
                        <a href="assets/images/img/programs/healthcare/health-camp-ursuline.jpg" class="img-popup">
                            ...
                            <div class="content">
                                <p class="title text-center">Health Checkup Camp at Ursuline Intermediate College, Ranchi</p>
                            </div>
                        </a>
                    </div>
                    <div class="item col-md-3 col-sm-6 col-xs-12">
                ...
                <div class="section-title">
                    <h3>Dignity & Women Empowerment</h3>
                </div>
                <div class="row">
                    <div class="item col-md-3 col-sm-6 col-xs-12">
                ...
                <div class="section-title">
                    <h3>Encouraging & Appreciating Youth</h3>
                </div>
                <div class="row">
                    <div class="item col-md-3 col-sm-6 col-xs-12">
